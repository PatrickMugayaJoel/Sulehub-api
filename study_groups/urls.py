...
urlpatterns = [
    ...
    path('registrations/<int:member_id>/update', UpdateRegistrationView.as_view(), name='sg_reg_update'),
    ...
    path('<int:study_group_id>/registrations/', GetStudyGroupMembersView.as_view(), name='study_group_regs'),
]
